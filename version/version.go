...
// IsOfficialAPIVersion checks whether the provided version string follows a API version pattern
func IsOfficialAPIVersion(versionStr string) bool {
	_, err := version.NewSemver(versionStr)
	return err == nil
}

// GetOfficialAPIVersion extracts the KubeVela version from the provided string
// More precisely, this method returns the segments and prerelease info w/o metadata
func GetOfficialAPIVersion(versionStr string) (string, error) {
