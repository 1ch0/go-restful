...
RUN GO111MODULE=on CGO_ENABLED=0 GOOS=linux GOARCH=${TARGETARCH} \
    go build -a -ldflags "-s -w -X github.com/1ch0/go-restful/version.VelaVersion=${VERSION:-undefined} -X github.com/1ch0/go-restful/version.GitRevision=${GITVERSION:-undefined}" \
