...
func main() {
	...
	flag.StringVar(&s.serverConfig.Datastore.URL, "datastore-url", "mongodb://root:xxx@124.223.36.219:57017", "Metadata storage database url,takes effect when the storage driver is mongodb.")
	flag.Parse()
